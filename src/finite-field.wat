(module
  ...
  ;; (import "./finite-field-gen.32.wat" "multiply" (func $multiply.32 (param i32 i32 i32)))

  (func $square.unrolled (param $xx i32) (param $x i32)
    (call $multiply.unrolled (local.get $xx) (local.get $x) (local.get $x))
  )

  (export "multiply" (func $multiply.unrolled))
  (export "square" (func $square.unrolled))
  ...
  (export "reduce" (func $reduce.381.12_leg))
  (export "isEqual" (func $equals.381.12_leg))
