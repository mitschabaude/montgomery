 ...
 * @type {Record<number, [number, number] | undefined>}
 */
let cTable = {
  [14]: [13, 7],
  [16]: [15, 8],
...
/**
 * @typedef {{x: bigint; y: bigint; isInfinity: boolean}} InputPoint
 */
 ...
 *
 * @param {bigint[]} inputScalars `s_0, ..., s_(N-1)`
 ...
 */
function msmBigint(inputScalars, inputPoints, { c: c_, c0: c0_ } = {}) {
